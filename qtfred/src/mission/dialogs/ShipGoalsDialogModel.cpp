...
namespace fred {
namespace dialogs {
ShipGoalsDialogModel::ShipGoalsDialogModel(QObject* parent, EditorViewport* viewport, bool multi)
...
void ShipGoalsDialogModel::setSubsys(int pos, int data)
{
	modify(m_subsys[pos], data);
}
int ShipGoalsDialogModel::getSubsys(int pos)
{
	return m_subsys[pos];
}
