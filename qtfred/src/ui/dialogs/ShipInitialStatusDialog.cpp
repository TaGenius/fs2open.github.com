...
ShipInitialStatusDialog::~ShipInitialStatusDialog() {}
...
{ // enable/disable dropdown
	ui->dockeeComboBox->setEnabled((dock_types >= 0) ? true : false);
...
void ShipInitialStatusDialog::list_dockee_points(int shipnum)
{
	...
	// enable/disable dropdown
	ui->dockeePointComboBox->setEnabled((shipnum >= 0) ? true : false);
